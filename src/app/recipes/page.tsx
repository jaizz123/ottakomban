        ...
        <section className="cocktail-section">
          <div className="cocktail-content">
            <div className="cocktail-image left">
              ...
              <img src="/images/cocktail1.png" alt="Gooseberry Sparkler" />
            </div>
...
Top with ginger beer and garnish with mint.</p>
            ...
            <div className="cocktail-image right">
              <img src="/images/cocktail2.jpeg" alt="Classic Red Mule" />
            </div>
          </div>
        </section>
        ...
        <section className="cocktail-section">
          <div className="cocktail-content">
            <div className="cocktail-image left">
              <img src="/images/cocktail3.webp" alt="Nutmeg Highball" />
            </div>
            <div className="cocktail-text right">
              <h2>KERALA SUNSET</h2>
